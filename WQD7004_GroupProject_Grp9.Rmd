...
Airline satisfaction is a crucial aspect in the aviation industry as it directly impacts the loyalty and customer retention. Airline satisfaction data which is collected from Kaggle are used to conduct various analysis to understand passenger preferences in airline services. With the insights and conclusions from this analysis, we seek to improve the airline services and increase the passenger satisfaction.
...
# Objectives
1. To determine the main factor that affects the passenger satisfaction.
2. To understand the correlation between the services provided by Airline.
3. To evaluate the performance of classification model and identify the best model in terms of accuracy.
...
```
92 and 310 missing values were detected in continuous data, which are the attributes of Departure.Delay.in.Minutes and Arrival.Delay.in.Minutes respectively.  
...
The accuracy score for Decision Tree model is 95, which is relatively high.
