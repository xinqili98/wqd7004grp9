...
For Business Travel, while the first four services listed have similarly distributed ratings, the latter eight services have relatively high ratings, indicating a strong performance in those areas. Thus, airline should focus more on improving the performance of the first four services, which have similarly distributed ratings.</li>
</p>
For Personal Travel, while the service "Departure Arrival time convenient" has relatively high ratings, other services should also focus on improving their ratings from "2" to "4" to "3" to "5". </li>
</p>
