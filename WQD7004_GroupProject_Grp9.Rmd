...
*  Chart below is a plot of satisfaction (count of satisfied customers) based on age. It is evident from the plot that more number of younger customers (20–60 years) are satisfied with the airline, whereas a higher number of customers (10–60 years) are dissatisfied with the airline. Older customers were in general more satisfied with all features and rated them higher compared to younger travellers. This could indicate that younger travelers are more critical of factors and have higher expectations from products when compared to older/ middle aged population.
