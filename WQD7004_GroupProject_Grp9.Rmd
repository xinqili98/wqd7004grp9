...
# Methodology
## Data Understanding
In this report, we analyze the Airline satisfaction dataset which contains 24 distinct features and 103,904 entries. The dataset includes information on various aspects of the flight experience, including in-flight Wi-Fi service, ease of online booking, gate location, food and drink, seat comfort, in-flight entertainment, on-board service, legroom, baggage handling, check-in service, cleanliness, and passenger demographics such as gender, age, and type of travel. 
...
Besides, the data is composed of categorical and numerical variables, which allows us to understand the behavior of the passengers and their level of satisfaction. It will be explored and cleaned to identify any potential issues or outliers before conducting the analysis.
