...
# Methodology
## Data Understanding
In this report, we analyze the Airline satisfaction dataset which contains 24 distinct features and 103,904 entries. The dataset includes information on various aspects of the flight experience, including inflight wifi service, ease of online booking, gate location, food and drink, seat comfort, inflight entertainment, on-board service, legroom, baggage handling, check-in service, cleanliness, and passenger demographics such as gender, age, and type of travel. The dataset also includes information on departure and arrival delay times, as well as the passenger's overall satisfaction with their flight experience. The data is composed of categorical, ordinal and character variables, which allows us to understand the behavior of the passengers and their level of satisfaction. The data will be explored and cleaned to identify any potential issues or outliers before conducting the analysis.
